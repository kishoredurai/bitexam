...
<div class="card">
	<div class="card-header">
		<div class="row">
			<div class="col-md-9">
				<h3 class="panel-title"> <?php echo $row["coe_name"]; ?> Online Exam List</h3>
			</div>
        		...
        		<div class="modal-body">
					  ...
					  <div class="form-group">
            			<div class="row">
							...
							<div class="form-group">
            			<div class="row">
              				<label class="col-md-4 text-right">STAFF : <span class="text-danger">*</span></label>
	              			<div class="col-md-8">
	                			<select name="staff_id" id="online_staff_id" class="form-control">
								<?php
							require_once '../include/db.php';
...
$(document).ready(function(){
	...
	var dataTable = $('#exam_data_table').DataTable();
	 ...
	 dataTable = $('#exam_data_table').DataTable({
		"processing" : true,
		"serverSide" : true,
		"order" : [],
		"ajax" : {
