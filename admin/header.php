    ...
    <nav class="navbar navbar-expand-sm  navbar-light   " style="background-color: #dedede ;">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                <div class="topnav">
                        <a class="nav-link dropdown" style="color: black;" class="nav-link" href="#">Queries</a></div>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" href="coe_feedback.php">Feedback</a>
                        <a class="dropdown-item" href="coe_malfeedback.php">Mal-Feedback</a>
                </li>
